...
#table_array=$(echo 'NoMosaic,tet2,DNMT')
#table_array=$(echo 'tet2,DNMT')
#table_array=$(echo 'DNMT')
...
#		outfile=$(echo "$ENSG""__""FINAL_file_""$table_array_sel"".out.gz")
    ...
    Rscript_Match_TF_occupancy=$(echo "$Rscripts_path""431_TF_motif_classification_of_variants_v2.R")
