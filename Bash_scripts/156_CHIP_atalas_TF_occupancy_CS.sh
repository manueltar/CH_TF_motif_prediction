...
$ cut -f1 TF_experiments_search_file_CS_1.tsv|sort|uniq -c|sort -rg|awk -F" " '{print $2}' > ENSG_CS_file.txt
...
exit
    ...
    TF_motif_prediction=$(echo "/group/soranzo/manuel.tardaguila/CH/ALL_variants_in_CS/TF_motif_analysis/""TF_motif_prediction_""$table_array_sel"".bed")
    ...
    Final_table_TF_motif_prediction=$(echo "/group/soranzo/manuel.tardaguila/CH/ALL_variants_in_CS/TF_motif_analysis/""Final_table_TF_motif_prediction_""$table_array_sel"".tsv")
    out2=$(echo "/group/soranzo/manuel.tardaguila/CH/ALL_variants_in_CS/")
