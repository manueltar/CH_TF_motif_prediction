...
Rscript_printer_fasta_files=$(echo "$Rscripts_path""427_Printer_of_input_fasta_files_v3.R")
...
do
    ...
    Rscript_collect_TF_motif_results=$(echo "$Rscripts_path""428_TFmotif_collection_only_v2_michelas_snps_v3.R")
...
Rscript_final_TF_table=$(echo "$Rscripts_path""429_Final_table_of_TF_motifs_predicted_v3.R")
