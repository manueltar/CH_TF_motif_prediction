...
do
    ...
    Final_table_TF_motif_prediction=$(echo "/group/soranzo/manuel.tardaguila/CH/ALL_variants_in_CS/""Final_table_TF_motif_prediction_with_chipseq_support_""$table_array_sel"".tsv")
