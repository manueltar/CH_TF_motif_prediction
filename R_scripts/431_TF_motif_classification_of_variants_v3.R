...
merge_with_final_table = function(option_list)
{
  ...
  colnames(TF_motifs_with_an_experimental_HIT)[which(colnames(TF_motifs_with_an_experimental_HIT) == 'chip_seq_experiment_string')]<-'BLOOD_chip_seq_experiment_string'
